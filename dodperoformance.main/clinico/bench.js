/* ==========================================================================
   bench.js — camada da bancada clínica (andar de cima)
...
(function bench() {
  ...
  function refreshHonesty() {
    ...
    // A REGRA FORTE só vale dentro do clínico verificado. Fora da porta, dorme.
    if (!window.__clinicoVerified) {
      banner.hidden = true;
      return;
    }
  ...
  window.__clinicoActivateHonesty = refreshHonesty;
